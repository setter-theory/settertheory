...
function printMatchPdfReport(){
  ...
  // V150.138: PDFプレビュー／PDF印刷ではAquila Adviceを従来どおり全文表示する。
  ...
  cover.innerHTML=`<div class="pdfCoverInner">
    ...
    <div class="pdfCoverVersion">V150.138</div>
  </div>`;
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* V150.138: PDF preview / print setter-analysis card — all four corners rounded. */
    #report #reportDashboard.pdfA4Document > .pdfSetterPage .setterAnalysisUnit{
      border-radius:18px!important;
      overflow:hidden!important;
    ...
    <div class="pdfPreviewBuildMarker">V150.138</div>
