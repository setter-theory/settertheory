const CACHE_NAME = 'settertheory-v150175-launch-visibility-fix';
const ASSETS=[
  './assets/aquila_real.webp','./','./index.html','./app_v141_setter_split.js?v=150175','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
