const CACHE_NAME = 'settertheory-v150-290-save-finish-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150289','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
