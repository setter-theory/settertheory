const CACHE_NAME = 'settertheory-v15053-pdf-rotation-divider-clear';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15053','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
