const CACHE_NAME='setter-theory-v146-3-report-header';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-3-report-header','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
