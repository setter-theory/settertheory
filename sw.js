const CACHE_NAME = 'setter-theory-v68-inline-cancel';
const ASSETS=['./','index.html','app.js?v=67-instant-record-inline-undo','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
