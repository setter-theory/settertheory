const CACHE_NAME = 'settertheory-v150172-aquila-first-launch';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150172','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
