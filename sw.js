const CACHE_NAME='setter-theory-v88-substitution-stability';
const ASSETS=['./','index.html','app.js?v=87-autosave-resume-real','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
