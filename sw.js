const CACHE_NAME = 'settertheory-v1509-pdf-margin-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15009','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
