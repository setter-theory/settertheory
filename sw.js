const CACHE_NAME = 'settertheory-v15017-pdf-fixed-report';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15017','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
