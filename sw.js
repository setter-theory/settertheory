const CACHE_NAME = 'setter-theory-v85-rotation-adjust';
const ASSETS=['./','index.html','app.js?v=85-rotation-adjust','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
