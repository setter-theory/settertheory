const CACHE_NAME = 'settertheory-v150170-saved-two-setter-pdf';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150170','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
