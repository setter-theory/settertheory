const CACHE_NAME = 'settertheory-v15050-pdf-ability-title-white';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15050','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
