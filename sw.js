const CACHE_NAME = 'settertheory-v150113-analysis-card-finish';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150113','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
