const CACHE_NAME='setter-theory-v60-ipad-pwa-focus';
const ASSETS=['./','index.html','app.js?v=61-standalone-input-editor','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
