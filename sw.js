const CACHE_NAME = 'settertheory-v15054-pdf-rotation-count-clear';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15054','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
