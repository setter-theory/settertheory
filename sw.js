const CACHE_NAME = 'settertheory-v150114-analysis-card-finish';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150114','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
