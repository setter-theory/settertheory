const CACHE_NAME = 'settertheory-v150185-player-analysis';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150185','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
