const CACHE_NAME = 'settertheory-v150165-saved-matches-by-team';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150165','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
