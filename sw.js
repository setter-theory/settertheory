const CACHE_NAME = 'settertheory-v15045-pdf-team-metric-breakdown';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15045','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
