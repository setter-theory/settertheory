const CACHE_NAME = 'settertheory-v150182-logo-flicker-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150182','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
