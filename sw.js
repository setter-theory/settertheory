const CACHE_NAME = 'settertheory-v150177-logo-only-intro';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150177','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
