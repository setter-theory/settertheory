const CACHE_NAME = 'settertheory-v15049-pdf-setter-card-expand';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15049','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
