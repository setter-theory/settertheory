const CACHE_NAME = 'settertheory-v15065-parent-card-print-surface';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15065','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
