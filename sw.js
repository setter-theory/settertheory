const CACHE_NAME='setter-theory-v147-aquila-branding';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=147-aquila-branding-1','./manifest.json','./icons/aquila-152.png','./icons/aquila-192.png','./icons/aquila-512.png'];
