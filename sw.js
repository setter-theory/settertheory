const CACHE_NAME = 'settertheory-v15061-ranking-white-version-unified';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15061','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
