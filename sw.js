const CACHE_NAME = 'settertheory-v151-1-43-serve-target-attack-endline-fit';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=151142','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
