const CACHE_NAME = 'setter-theory-v146-fixed-header-two-setter-iq-1';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-fixed-header-two-setter-iq-1','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
