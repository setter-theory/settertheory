const CACHE_NAME = 'settertheory-v15060-pdf-preview-active-script-subcards';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15060','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
