const CACHE_NAME = 'settertheory-v150100-rotation-text-white';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150100','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
