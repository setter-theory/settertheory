const CACHE_NAME = 'settertheory-v150-299-coach-wide-position-colors';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150299','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
