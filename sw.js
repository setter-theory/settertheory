const CACHE_NAME = 'settertheory-v150171-launch-landing';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150171','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
