const CACHE_NAME = 'settertheory-v150183-deferred-logo-mount';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150183','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
