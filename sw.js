const CACHE_NAME = 'settertheory-v150180-guest-button-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150180','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
