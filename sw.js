const CACHE_NAME = 'settertheory-v151-0-2-coach-major-update';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=151001','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
