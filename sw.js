const CACHE_NAME = 'settertheory-v15046-toss-title-color';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15046','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
