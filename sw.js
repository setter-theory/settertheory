const CACHE_NAME = 'settertheory-v150169-team-quick-match-setup';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150169','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
