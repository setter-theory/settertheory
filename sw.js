const CACHE_NAME = 'settertheory-v151-1-36-reception-multiplayer';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=151134','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
