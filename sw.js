const CACHE_NAME = 'settertheory-v150178-boot-order-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150178','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
