const CACHE_NAME = 'settertheory-v15057-setter-analysis-full-width';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15057','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
