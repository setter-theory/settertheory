const CACHE_NAME = 'settertheory-v150-full-document-print';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=14901','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
