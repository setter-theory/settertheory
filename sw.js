const CACHE_NAME = 'setter-theory-v98-4-compact-independent-position-ui';
const ASSETS=['./','index.html','app.js?v=98-2-double-substitution','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
