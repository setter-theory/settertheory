const CACHE_NAME='setter-theory-v33';
self.addEventListener('install',e=>{self.skipWaiting();e.waitUntil(caches.open(CACHE_NAME).then(c=>c.addAll(['./','index.html','app.js','manifest.json','sw.js'])));});
