const CACHE_NAME = 'settertheory-v151-1-48-reception-dig-dual-growth';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=151146','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
