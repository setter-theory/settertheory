const CACHE_NAME = 'settertheory-v151-1-55-toss-practice-growth';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=151153','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
