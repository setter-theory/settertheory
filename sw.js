const CACHE_NAME = 'settertheory-v15084-pdf-ability-radar-inner-only';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15084','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
