const CACHE_NAME='setter-theory-v146-1-resume-recovery';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-1-resume-recovery','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
