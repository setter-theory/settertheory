const CACHE_NAME = 'settertheory-v150174-real-aquila';
const ASSETS=[
  './assets/aquila_real.webp','./','./index.html','./app_v141_setter_split.js?v=150174','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
