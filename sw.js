const CACHE_NAME = 'setter-theory-v146-equal-panels-rotation-below-point-1';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-team-analysis-height-compact-1','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
