const CACHE_NAME = 'setter-theory-v102-3-report-restore';
const ASSETS=['./','index.html','app.js?v=102-3-report-restore','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
