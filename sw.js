const CACHE_NAME = 'setter-theory-v137-rotation-point-diverging-bars';
const ASSETS=['./','./index.html','./app_v137_rotation_point_diverging_bars.js?v=137-rotation-point-diverging-bars','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
