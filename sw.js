const CACHE_NAME = 'settertheory-v15089-print-radar-position-only';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15089','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
