const CACHE_NAME = 'settertheory-v150168-previous-year-copy';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150168','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
