const CACHE_NAME='setter-theory-v90-3-report-return-serve-fix';
const ASSETS=['./','index.html','app.js?v=90-2-report-return-serve-fix','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
