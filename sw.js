const CACHE_NAME='setter-theory-v146-14-match-summary-value-align';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-14-match-summary-value-align','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
