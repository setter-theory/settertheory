const CACHE_NAME = 'settertheory-v150128-saved-report-advice-accordion';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150128','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
