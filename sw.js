const CACHE_NAME = 'settertheory-v150158-team-year-management';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150158','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
