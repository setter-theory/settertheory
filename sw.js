const CACHE_NAME = 'settertheory-v150187-player-analysis';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150187','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
