const CACHE_NAME = 'settertheory-v150163-saved-setter-card1-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150163','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
