const CACHE_NAME = 'setter-theory-v132-log-frozen-columns-scroll';
const ASSETS=['./','./index.html','./app.js?v=125-home-cleanup','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
