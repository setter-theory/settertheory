const CACHE_NAME = 'setter-theory-v96-cumulative-growth-diff-fix';
const ASSETS=['./','index.html','app.js?v=96-cumulative-growth-diff-fix','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
