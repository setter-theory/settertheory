const CACHE_NAME = 'settertheory-v15011-pdf-recovery';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15011','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
