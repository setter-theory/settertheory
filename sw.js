const CACHE_NAME = 'settertheory-v150160-rotation-team-link';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150160','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
