const CACHE_NAME = 'settertheory-v150197-player-evaluation-colors';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150197','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
