const CACHE_NAME = 'settertheory-v150186-player-analysis';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150186','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
