const CACHE_NAME = 'settertheory-v15042-pdf-card-contrast';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15042','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
