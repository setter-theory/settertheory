const CACHE_NAME = 'settertheory-v150126-saved-report-advice-accordion';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150126','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
