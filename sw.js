const CACHE_NAME = 'settertheory-v150-297-coach-lineup-standard-order';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150297','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
