const CACHE_NAME = 'settertheory-v150181-launch-timing-polish';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150181','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
