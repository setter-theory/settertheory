const CACHE_NAME = 'settertheory-v15066-parent-surface-navy';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15066','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
