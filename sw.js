const CACHE_NAME = 'setter-theory-v122-persistent-save-finish-archive';
const ASSETS=['./','./index.html','./app.js?v=122-persistent-save-finish-archive','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
