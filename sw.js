const CACHE_NAME = "settertheory-v146-team-analysis-rotation-clean-1";
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-team-analysis-rotation-clean-1','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
