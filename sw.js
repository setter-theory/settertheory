const CACHE_NAME='settertheory-v92-1-two-setter-full';
const ASSETS=['./','index.html','app.js?v=92-1-two-setter-full','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
