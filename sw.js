const CACHE_NAME = 'settertheory-v150176-aquila-flyin-impact';
const ASSETS=[
  './assets/aquila_real.webp','./','./index.html','./app_v141_setter_split.js?v=150176','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
