const CACHE_NAME = 'setter-theory-v86-setup-puzzle-menu';
const ASSETS=['./','index.html','app.js?v=86-setup-puzzle-menu','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
