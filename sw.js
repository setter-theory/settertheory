const CACHE_NAME = 'setter-theory-v107-layout-only';
const ASSETS=['./','./index.html','./app.js?v=107-layout-only','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
