const CACHE_NAME = 'settertheory-v150130-saved-report-advice-toggle';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150130','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
