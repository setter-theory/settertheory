const CACHE_NAME = 'settertheory-v15070-dark-smallcards-analysis-parent-donut';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15070','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
