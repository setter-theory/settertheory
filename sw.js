const CACHE_NAME='setter-theory-v146-16-all-substitution-history';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-16-all-substitution-history','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
