const CACHE_NAME = 'settertheory-v151-1-57-saved-data-pdf-stability';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=151157','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
