const CACHE_NAME = 'settertheory-v1504-full-height-print';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15004','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
