const CACHE_NAME = 'setter-theory-v141-rotation-toss-distribution-fixed';
const ASSETS=['./','./index.html','./app_v141_rotation_toss_distribution.js?v=141-rotation-toss-distribution-fixed','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
