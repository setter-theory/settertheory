const CACHE_NAME = 'settertheory-v150201-player-rank-advice';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150201','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
