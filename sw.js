const CACHE_NAME = 'settertheory-v150196-player-evaluation-colors';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150196','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
