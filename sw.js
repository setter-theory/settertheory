const CACHE_NAME = 'settertheory-v15014-pdf-recovery';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15014','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
