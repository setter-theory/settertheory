const CACHE_NAME = 'setter-theory-v107-setter-iq-radar-chart';
const ASSETS=['./','./index.html','./app.js?v=1063-ranking-order-fix','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
