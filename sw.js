const CACHE_NAME = 'settertheory-v150162-saved-one-setter-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150162','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
