const CACHE_NAME = 'setter-theory-v102-2-ipad-saved-report';
const ASSETS=['./','index.html','app.js?v=102-2-ipad-saved-report','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
