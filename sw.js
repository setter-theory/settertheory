const CACHE_NAME = 'settertheory-v150190-player-direct-click';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150188','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
