const CACHE_NAME = 'settertheory-v150164-saved-setter-iq-sync';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150164','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
