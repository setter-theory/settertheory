const CACHE_NAME = 'settertheory-v151-1-33-csv-score-excel-safe';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=151133','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
