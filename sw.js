const CACHE_NAME = 'settertheory-v15062-print-card-background-match';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15062','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
