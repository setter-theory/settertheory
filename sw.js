const CACHE_NAME = 'settertheory-v150159-player-management';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150159','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
