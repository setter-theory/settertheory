const CACHE_NAME = 'settertheory-v15048-pdf-setter-card-expand';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15048','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
