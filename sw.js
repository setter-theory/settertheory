const CACHE_NAME = 'setter-theory-v121-resume-current-state-fix';
const ASSETS=['./','./index.html','./app.js?v=121-resume-current-state-fix','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
