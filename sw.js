const CACHE_NAME = 'settertheory-v150173-aquila-carries-title';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150173','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
