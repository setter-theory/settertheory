const CACHE_NAME = 'settertheory-v150167-saved-match-team-reassign';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150167','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
