const CACHE_NAME = 'settertheory-v151-1-2-coach-athlete-ui';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=151120','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
