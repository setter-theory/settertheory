const CACHE_NAME = 'settertheory-v150-296-coach-card-fit-initial-sync';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150293','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
