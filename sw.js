const CACHE_NAME = 'settertheory-v150-245-coach-flip-all-drawings-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150208','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
