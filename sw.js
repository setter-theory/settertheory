const CACHE_NAME='settertheory-v90-4-input-order-customize';
const ASSETS=['./','index.html','app.js?v=90-4-input-order-customize','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
