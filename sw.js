const CACHE_NAME = "settertheory-v146-play-metrics-onebar-toss-fix-1";
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-play-metrics-bars-2','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
