const CACHE_NAME = 'settertheory-v150111-pdf-analysis-master-card';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150111','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
