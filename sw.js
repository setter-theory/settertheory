const CACHE_NAME = 'settertheory-v15012-setter-page-break';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15012','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
