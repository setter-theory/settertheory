const CACHE_NAME = 'settertheory-v150184-report-screen-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150184','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
