const CACHE_NAME = 'setter-theory-v1062-ranking-switch-fix';
const ASSETS=['./','./index.html','./app.js?v=1062-ranking-switch-fix','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
