const CACHE_NAME = 'setter-theory-v66';
const ASSETS=['./','index.html','app.js?v=66-number-first-play-record','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
