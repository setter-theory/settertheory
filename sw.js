const CACHE_NAME='setter-theory-v146-5-csv-pdf-button';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-4-csv-width','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
