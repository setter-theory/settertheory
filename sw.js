const CACHE_NAME='settertheory-v91-toast-top-right';
const ASSETS=['./','index.html','app.js?v=91-toast-top-right','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
