const CACHE_NAME = 'settertheory-v15055-pdf-rotation-count-extra-clearance';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15055','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
