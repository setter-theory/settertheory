const CACHE_NAME = 'settertheory-v151-0-0-coach-major-update';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=151000','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
