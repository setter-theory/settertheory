const CACHE_NAME='setter-theory-v90-manual-serve-toggle';
const ASSETS=['./','index.html','app.js?v=90-manual-serve-toggle','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
