const CACHE_NAME='setter-theory-v62-native-input-finish';
const ASSETS=['./','index.html','app.js?v=62-native-input-finish','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
