const CACHE_NAME = 'settertheory-v150157-home-accordion-layout';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150157','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
