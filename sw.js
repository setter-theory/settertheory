const CACHE_NAME='setter-theory-v146-6-setter-summary';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-6-setter-summary','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
