const CACHE_NAME='settertheory-v93-1-second-ball';
const ASSETS=['./','index.html','app.js?v=93-second-ball','manifest.json','sw.js','icons/aquila-192.png','icons/aquila-512.png'];
