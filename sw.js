const CACHE_NAME = 'settertheory-v15087-print-radar-five-items-fit';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15087','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
