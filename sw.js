const CACHE_NAME = 'settertheory-v15010-pdf-fixed-pages';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15010','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
