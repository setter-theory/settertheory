const CACHE_NAME = 'settertheory-v15063-parent-card-surface-match';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15063','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
