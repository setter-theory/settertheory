const CACHE_NAME = 'settertheory-v15035-pdf-actual-layout-fix';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=15035','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
