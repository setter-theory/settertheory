const CACHE_NAME = 'settertheory-v146-setter-rank-colors';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=146-setter-rank-colors-1','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
