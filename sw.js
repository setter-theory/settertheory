const CACHE_NAME = 'settertheory-v150112-pdf-analysis-master-card';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=150112','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
